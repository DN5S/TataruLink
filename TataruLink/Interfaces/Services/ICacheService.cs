...
public interface ICacheService
{
    ...
    bool TryGet(string originalText, string sourceLanguage, string targetLanguage, out TranslationResults? record);

    /// <summary>
    /// Adds or updates a TranslationRecord in the cache. The key is derived from the record's content.
    /// </summary>
    /// <param name="translationResults">The TranslationRecord to add or update.</param>
    void Set(TranslationResults translationResults);
    ...
    IEnumerable<TranslationResults> GetHistory();
